...
@section('seo_info')
    ...
    <title>JapaLearn terms and conditions</title>
    <meta name="description" content="The terms and conditions of JapaLearn">
@endsection
...
@section('content')
    ...
    <div class="mt-4 policy">
        ...
        <ul>
            ...
            <li>
                <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to JapaLearn, 399 denonville, J4L 2P8.</p>
            </li>
            <li>
            ...
            <li>
                <p><strong>Website</strong> refers to JapaLearn, accessible from <a href="https://japalearn.com" rel="external nofollow noopener" target="_blank">https://japalearn.com</a></p>
            </li>
            <li>
        ...
        <p>If You are a copyright owner, or authorized on behalf of one, and You believe that the copyrighted work has been copied in a way that constitutes copyright infringement that is taking place through the Service, You must submit Your notice in writing to the attention of our copyright agent via email at info@japalearn.com and include in Your notice a detailed description of the alleged infringement.</p>
        ...
        <p>You can contact our copyright agent via email at info@japalearn.com.
        ...
        <ul>
            <li>By email: info@japalearn.com</li>
        </ul>
    </div>
