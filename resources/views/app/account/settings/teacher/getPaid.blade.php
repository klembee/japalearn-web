    ...
    <md-content class="mt-3">
        @if(!$stripeSettedUp)
            ...
            <md-button
                ...
                href="https://connect.stripe.com/express/oauth/authorize?client_id=ca_H6v5WaI8qXpgzmqjOWtRg0YmkElxjEGf&state={{$user->stripe_state}}&suggested_capabilities[]=transfers&stripe_user[email]={{$user->email}}&stripe_user[country]=CA&stripe_user[first_name]={{$user->firstname}}&stripe_user[first_name]={{$user->lastname}}&stripe_user[currency]=cad">Setup stripe account</md-button>
        @else
